...
helm4jConventions {
    coverageExclusions =
        listOf(
            ...
            "dev/nthings/helm4j/runtime/ffm/internal/FfmHelmBridge*",
            "dev/nthings/helm4j/runtime/ffm/FfmHelmEngineProvider*",
            "dev/nthings/helm4j/runtime/ffm/internal/NativeLibrary*",
        )
}
...
tasks.jar {
    manifest {
        attributes("Enable-Native-Access" to "dev.nthings.helm4j.runtime.ffm")
    }
}
