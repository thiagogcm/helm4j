 ...
 *
 * <p>
 * All parameters and return values are raw UTF-8 encoded byte arrays. The
 * bridge implementation
 * is responsible for converting these to the native format required by the
 * underlying library
 * (e.g., null-terminated C strings for FFM). This avoids unnecessary String
 * encoding/decoding at
 * the boundary.
 *
 * <p>
 * Implementations must be safe to call from a single thread. Concurrent access
 * is not required.
 */
