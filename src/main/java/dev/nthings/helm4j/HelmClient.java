...
import dev.nthings.helm4j.internal.sdk.FfmNativeStructBridge;
...
public final class HelmClient implements AutoCloseable {
  ...
  public static final class Builder {
    ...
    private NativeStructBridge nativeBridge;
    ...
    public Builder withNativeBridge(NativeStructBridge value) {
      this.nativeBridge = Objects.requireNonNull(value, "value");
      return this;
    }

    public HelmClient build() {
      var resolvedMapper = mapper == null ? defaultMapper() : mapper;
      var resolvedBridge = nativeBridge == null ? new FfmNativeStructBridge() : nativeBridge;
