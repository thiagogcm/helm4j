 ...
 * AddRepositoryFailure}) carry one as a value, and {@link HelmException} carries one when failure
...
public record HelmFailure(
  ...
  public HelmFailure(
      ...
      @Nullable Optional<String> hint) {
    this.message = Objects.requireNonNull(message, "message");
    this.stage = stage;
    this.operation = operation;
    this.hint = hint == null ? Optional.empty() : hint;
  }
