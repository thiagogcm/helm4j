...
public record UpdateRepositories(List<String> names, @Nullable Duration timeout) {
  ...
  public static final class Builder {
    ...
    public UpdateRepositories build() {
      return new UpdateRepositories(normalizeNames(names), timeout);
    }
  }
